...
[View Vignette](https://iangault.github.io/vignette-temporal-trends/){.btn .btn-primary style="margin-right: 0.5rem; font-size: 1rem;"}
[View on GitHub](https://github.com/iangault/vignette-temporal-trends){.btn .btn-secondary style="font-size: 1rem;"}
</div>
